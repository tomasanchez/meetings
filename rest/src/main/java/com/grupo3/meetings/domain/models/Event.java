...
public class Event {
   ...
   */
  public Event(String title, String description, String location, User administrator,
      Set<Option> listOfOptions) {
    this.title = title;
  ...
  public Event(EventDTO eventDTO) {
    ...
    this.listOfOptions = eventDTO.getOptions().stream().map(dto -> dto.toOptionForEvent())
